...
namespace Eadesigndev\Slider\Block\Adminhtml\SliderItem;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Eadesigndev_Slider::save_slideritem')) {
        ...
        if ($this->_isAllowedAction('Eadesigndev_Slider::delete_slideritem')) {
