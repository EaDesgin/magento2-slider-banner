...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Eadesigndev_Slider::save_slideritem');
    }
    ...
    public function execute()
    {
        ...
        if ($data) {
            /** @var \Eadesigndev\Slider\Model\SliderItem $model */
            ...
            /** @var \Eadesigndev\Slider\Model\Slider $slider */
            $slider = $this->_objectManager->create('\Eadesigndev\Slider\Model\Slider');
    ...
    public function getImageUrl($filePath)
    {
        if (!$this->mediaDirectory->isFile($filePath)) {
            $url = $this->assetRepo->getUrl(
                "Eadesigndev_Slider::images/slideritem/placeholder/thumbnail.jpg"
            );
        } else {
